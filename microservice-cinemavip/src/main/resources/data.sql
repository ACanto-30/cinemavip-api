...
INSERT INTO Classifications (classification_name, minimum_age, recommendation, summary, image) VALUES ('AA', 'Todo público', 'Apto para todo público, dirigido a niños', 'Dirigidas a público más preescolar', 'xd');
INSERT INTO Classifications (classification_name, minimum_age, recommendation, summary, image) VALUES ('A', 'Todo público', 'Apto para todo público, se permite la entrada a niños menores a 7 años con un adulto, y mayores se recomienda la supervisión de un adulto', 'Peliculas infantiles con nula violencia', 'xd');
INSERT INTO Classifications (classification_name, minimum_age, recommendation, summary, image) VALUES ('B', 'Mayores a 12 años', 'Solo para mayores de 12 años, menores requieren supervisión, recomendada a adolescentes', 'Poseen escenas y referencias sexuales, violencia moderada o un poco fuerte, y consumo de sustancias controladas.', 'xd');
